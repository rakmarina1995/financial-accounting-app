...
export class Operations {
    ...
    async getOperations(filter = null) {
        if (filter === this.interval.getAttribute('id')) {
            filter = "interval&dateFrom=" + this.dateFrom.value + "&dateTo=" + this.dateTo.value;
        }
    ...
    showOperations() {
        const table = document.getElementsByClassName('row');
        ...
        if (this.operations) {
            ...
            this.operations.forEach(item => {
                ...
                numberElement.innerText = item.id;
    ...
    async deleteOperation(type,id,amount) {
        ...
        try {
            ...
            if (result) {
                ...
                if (type==='income'){
                    this.sidebar.updateBalance(balance-amount);
                }
                if (type==='expense'){
                    this.sidebar.updateBalance(balance+amount);
                }
